...
更新：**2026-09-24（晚二，清小账：skill 环境事实更正 + 两件裁决落地）**　·　设计文档 `docs/superpowers/specs/2026-09-22-mcm-skill-suite-design.md`　·　既得教训 `docs/mcm-suite-lessons.md`　·　进度台账 `.superpowers/sdd/progress.md`（git 忽略，是**恢复图**）

> **M6 试点：Task 1–3 完成（Task 3 经 8 轮），Task 4 已派但按用户要求暂停（零产出）。**
> 另有两件改变既有前提的事：**官方原题语料（2016–2026）已入库**、**本机 TeX 已装** —— 见 §A.1.2、§E.1。
> **§A.3／§A.4 的四件小账已于 2026-09-24 晚二清完**（commit `47f2335`、`279e75d`）→ **下一步回到主线：派 Task 4**。
...
| 分支 | 内容 |
| :--- | :--- |
| `main`（`d9c1e33`） | 历史 `Initial commit → 代码快照 → 合并 → 真 README`；**91 个文件** |
